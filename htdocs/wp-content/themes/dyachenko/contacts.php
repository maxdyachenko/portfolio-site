...
<div class="container">
	...
	<div class="content">
		<div class="content-part">
			<p>If you have any questions or suggestions, please follow social links and contact me...</p>
			<div class="socials">
...
<!--					<input type="text" id="text" name="text" placeholder="Ask something..." required>-->
<!--				</div>-->
<!--				<div class="group">-->
<!--					<label for="file">Do you have any file to share?</label>-->
