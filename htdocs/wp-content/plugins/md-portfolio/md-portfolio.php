...
add_action('plugins_loaded', 'md_plugin_init');
...
function md_plugin_init() {
	$data = get_all_data();
	foreach ($data as $value) {
		pll_register_string('about project', $value->about, 'portfolio' );
		pll_register_string('add. info for project', $value->info );
	}
	load_plugin_textdomain( 'md_portfolio', false, dirname( plugin_basename( __FILE__ )));
}
...
include 'inc/md-plugin-init.php';
